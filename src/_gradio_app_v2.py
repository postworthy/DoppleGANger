...
with gr.Blocks() as iface:
    with gr.Tab("Processing"):
        ...
        #image_input = gr.Image(type="filepath", label="Upload Image", multiple=True)
        image_input = gr.File(file_count="multiple", type="filepath", label="Upload Images", file_types=["image"])
...
if __name__ == "__main__":
    ...
    face_swapper = AEINETSwapper(model_paths=(args.model_weights, f""), with_super_resolution=WITH_SUPER_RESOLUTION)
